 ...
 */
import * as gapicConfig from './gateway_service_client_config.json';
...
export class GatewayServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.gkeconnect.gateway.v1beta1.GatewayService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.gatewayServiceStub) {
      return this.gatewayServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.gkeconnect.gateway.v1beta1.GatewayService.
    this.gatewayServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.gkeconnect.gateway.v1beta1.GatewayService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.gkeconnect.gateway.v1beta1.GatewayService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const gatewayServiceStubMethods =
        ['getResource', 'postResource', 'deleteResource', 'putResource', 'patchResource'];
    for (const methodName of gatewayServiceStubMethods) {
      const callPromise = this.gatewayServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getResource(
      ...
      Promise<[
        ...
        protos.google.api.IHttpBody|undefined, {}|undefined
      ]>;
  getResource(
      request: protos.google.api.IHttpBody,
      options: CallOptions,
